...
const LayoutPhillips = ({ children, full }) => {
  const bodyColor = 'white';
  const communityData = {
    address: '4023 118 Avenue NW, Edmonton AB T5W 1A2',
    phone: '780-306-2337',
    name: 'Phillips Apartments Rentals',
    slug: '/phillips-apartment',
    slogan: 'Phillips Apartments ',
    links: {
      contact: {
        title: 'Contact Us',
...
LayoutPhillips.propTypes = {
  full: PropTypes.bool,
};
LayoutPhillips.defaultProps = {
  full: true,
};

export default LayoutPhillips;
