...
const LayoutSherwood = ({ children, full }) => {
  const bodyColor = 'white';
  const communityData = {
    address: '10 Fir Street, Sherwood Park AB T8A 1Z6',
    phone: '780-306-2337',
    name: 'Sherwood Manor',
    slug: '/sherwood-manor',
    slogan: 'Sherwood Manor Apartment Rentals Edmonton',
    links: {
      contact: {
        title: 'Contact Us',
...
LayoutSherwood.propTypes = {
  full: PropTypes.bool,
};
LayoutSherwood.defaultProps = {
  full: true,
};

export default LayoutSherwood;
