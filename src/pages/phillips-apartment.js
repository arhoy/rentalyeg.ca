...
import LayoutPhillips from '../components/layouts/LayoutPhillips';
...
export const query = graphql`
  {
    allContentfulCommunity(filter: { slug: { eq: "phillips-apartment" } }) {
      nodes {
        slug
        title
        section0heroImage {
...
export default PhillipsApartment;
